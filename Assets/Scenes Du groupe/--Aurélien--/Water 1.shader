...
Shader "Water 1"
{
	Properties
	{
		_ShallowColor("ShallowColor", Color) = (0,0.5247141,0.6132076,0)
		_DeepColor("DeepColor", Color) = (0,0.2982672,0.6132076,0)
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 panner11 = ( uv_TexCoord9 + 1 * _Time.y * float2( 0,0 ));
			float2 panner10 = ( uv_TexCoord9 + 1 * _Time.y * float2( 0,0 ));
			float3 temp_output_15_0 = BlendNormals( tex2D( _Waternormal, panner11 ).rgb , UnpackScaleNormal( tex2D( _Waternormal, panner10 ) ,0.3 ) );
			...
			float temp_output_29_0 = saturate( pow( ( abs( ( eyeDepth2 - ase_screenPos.w ) ) + _WaterDepth ) , _WaterFalloff ) );
			float4 lerpResult8 = lerp( _ShallowColor , _DeepColor , temp_output_29_0);
			...
			float4 lerpResult24 = lerp( lerpResult8 , screenColor17 , temp_output_29_0);
...
/*ASEBEGIN
Version=15001
204;92;1437;655;1317.364;408.4006;1;True;False
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;9;-2013.16,-211.5482;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ScreenDepthNode;2;-1754.037,483.0836;Float;False;0;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;14;-1696.936,2.998672;Float;False;Constant;_Float0;Float 0;3;0;Create;True;0;0;False;0;0.3;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;23;-1192.191,-612.5798;Float;False;Property;_Distorsion;Distorsion;3;0;Create;True;0;0;False;0;0;0.02;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;7;-1460.167,202.9755;Float;False;Property;_ShallowColor;ShallowColor;0;0;Create;True;0;0;False;0;0,0.5247141,0.6132076,0;0,0.5247141,0.6132076,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;6;-1457.681,422.3114;Float;False;Property;_DeepColor;DeepColor;1;0;Create;True;0;0;False;0;0,0.2982672,0.6132076,0;0,0.2982669,0.6132076,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;0,0;Float;False;True;2;Float;ASEMaterialInspector;0;0;Standard;Water 1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;0;False;0;Transparent;0.5;True;False;0;False;Transparent;;Transparent;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;False;2;SrcAlpha;OneMinusSrcAlpha;0;Zero;Zero;OFF;OFF;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;0;0;False;0;0;0;False;-1;-1;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=530572C1DB2C392514B6F05419010D5410F086E9